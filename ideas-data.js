...
const ideasData = {
    ...
    concepts: [
        ...
        {
            text: "A system that works only if no one questions it",
            tags: { tone: ['neutral', 'dark'], cast: ['solo', 'two'], budget: ['micro'], intensity: 3 }
        },
        {
            text: "Someone follows instructions meant for a different person",
            tags: { tone: ['comedy', 'dark'], cast: ['solo', 'two'], budget: ['micro'], intensity: 2 }
        },
        {
            text: "A process designed to prevent a problem creates it instead",
            tags: { tone: ['dark', 'comedy'], cast: ['solo', 'two'], budget: ['micro'], intensity: 3 }
        },
        {
            text: "A rule exists only because no one remembers removing it",
            tags: { tone: ['neutral', 'dark'], cast: ['two'], budget: ['micro'], intensity: 2 }
        },
        {
            text: "An authority that never appears but is constantly referenced",
            tags: { tone: ['dark', 'mystery'], cast: ['two', 'small'], budget: ['micro'], intensity: 3 }
        },
        {
            text: "A process continues even after its original purpose is gone",
            tags: { tone: ['neutral', 'dark'], cast: ['solo', 'two'], budget: ['micro'], intensity: 3 }
        },
        {
            text: "A task is completed correctly, but still considered wrong",
            tags: { tone: ['dark', 'comedy'], cast: ['two'], budget: ['micro'], intensity: 2 }
        }
    ...
    constraints: [
        ...
        {
            text: "The character must enter the frame from the same side every time",
            type: "visual",
            tags: { tone: ['neutral'] }
        },
        {
            text: "The camera never follows the character — it only waits",
            type: "visual",
            tags: { tone: ['neutral'] }
        },
        {
            text: "Every exit becomes the next entrance",
            type: "location",
            tags: { tone: ['experimental'] }
        },
        {
            text: "The same moment happens three times, with less dialogue each time",
            type: "structure",
            tags: { tone: ['experimental'] }
        },
        {
            text: "A rule is explained once, then obeyed incorrectly every time after",
            type: "dialogue",
            tags: { tone: ['comedy', 'dark'] }
        },
        {
            text: "Each repetition removes one person from the scene",
            type: "structure",
            tags: { tone: ['dark', 'mystery'] }
        },
        {
            text: "The character can only move when someone else speaks",
            type: "perspective",
            tags: { tone: ['experimental'] }
        },
        {
            text: "The character must stay overly polite no matter what's said to them",
            type: "dialogue",
            tags: { tone: ['comedy', 'dark'] }
        },
        {
            text: "Everyone agrees on something that is clearly false",
            type: "dialogue",
            tags: { tone: ['dark', 'comedy'] }
        },
        {
            text: "No one is allowed to acknowledge the most important person in the room",
            type: "perspective",
            tags: { tone: ['dark'] }
        },
        {
            text: "Every time the character speaks, they must repeat the last word they heard",
            type: "dialogue",
            tags: { tone: ['comedy', 'experimental'] }
        },
        {
            text: "The character must physically correct small mistakes no one else notices",
            type: "perspective",
            tags: { tone: ['comedy', 'dark'] }
        }
    ].map(normalizeIdeaEntry),
    ...
    twists: [
        ...
        "The scene ends when the character stops trying",
        "The solution creates a smaller problem immediately",
        "The character succeeds by doing nothing differently",
        "The final action is trivial but irreversible",
        "The rules were optional — the character keeps following them anyway",
        "The character realizes they could have stopped at any point"
    ].map(normalizeIdeaEntry),
    ...
    places: [
        ...
        {
            text: "A waiting room that never calls anyone",
            tags: { tone: ['dark'], budget: ['micro'] }
        },
        {
            text: "A checkpoint without a visible guard",
            tags: { tone: ['mystery', 'dark'], budget: ['micro'] }
        },
        {
            text: "A temporary office set up in the wrong place",
            tags: { tone: ['comedy', 'dark'], budget: ['micro'] }
        },
        {
            text: "A public space that has technically closed",
            tags: { tone: ['neutral', 'dark'], budget: ['micro'] }
        },
        {
            text: "A service desk with no staff",
            tags: { tone: ['dark'], budget: ['micro'] }
        },
        {
            text: "A room that exists only to redirect people elsewhere",
            tags: { tone: ['dark', 'comedy'], budget: ['micro'] }
        }
    ].map(normalizeIdeaEntry),
    ...
    objects: [
        ...
        "A broken timer everyone still obeys",
        "A numbered ticket that never gets called",
        "A stack of contradictory forms",
        "A badge that grants access to nothing useful",
        "A door layered with outdated instructions",
        "A receipt for something no one remembers buying"
    ].map(normalizeIdeaEntry),
...
const characters_additions = [
    ...
    // ===== LA B MEDIA CREW ARCHETYPES =====
    { text: "A person who deflects every compliment with a redirect", tags: { tone: ["drama", "tender", "neutral"], cast: ["solo", "two"], intensity: 2 } },
    { text: "Someone who says 'we'll figure it out' like it's a promise", tags: { tone: ["drama", "tender", "neutral"], cast: ["solo", "two"], intensity: 2 } },
    { text: "A person who makes everyone feel like they're the most important person in the room", tags: { tone: ["drama", "tender"], cast: ["solo", "two"], intensity: 1 } },
    { text: "Someone who writes the scene nobody else can finish—and finishes it overnight", tags: { tone: ["drama", "dark", "tender"], cast: ["solo"], intensity: 3 } },
    { text: "A person who gets quieter the more they care", tags: { tone: ["drama", "tender", "neutral"], cast: ["solo", "two"], intensity: 2 } },
    { text: "Someone who asks 'what's this actually about?' and means it", tags: { tone: ["drama", "thriller", "neutral"], cast: ["solo", "two"], intensity: 2 } },
    { text: "A person who rewrites their own work in real time while explaining it", tags: { tone: ["drama", "comedy", "neutral"], cast: ["solo"], intensity: 2 } },
    { text: "Someone who stays calm when everyone else is spiraling—and it helps", tags: { tone: ["drama", "thriller", "neutral"], cast: ["solo", "two"], intensity: 2 } },
    { text: "A person who finishes other people's sentences—not to interrupt, but to include", tags: { tone: ["tender", "comedy", "drama"], cast: ["two"], intensity: 1 } },
    { text: "Someone who brings structure to chaos without killing what's alive in it", tags: { tone: ["drama", "neutral"], cast: ["solo", "two"], intensity: 2 } },
    { text: "Someone who commits to the bit completely—even when it embarrasses them", tags: { tone: ["comedy", "dark", "drama"], cast: ["solo", "two"], intensity: 2 } },
    { text: "A person who finds the dark version before anyone else sees the light", tags: { tone: ["dark", "thriller", "drama"], cast: ["solo", "two"], intensity: 3 } },
    { text: "Someone who plays silence like it's a dialogue line", tags: { tone: ["drama", "tender", "thriller"], cast: ["solo", "two"], intensity: 2 } },
    { text: "A person who escalates without warning—and it's always the right call", tags: { tone: ["thriller", "drama", "dark"], cast: ["solo", "two"], intensity: 3 } },
    { text: "Someone who makes stillness more interesting than movement", tags: { tone: ["drama", "tender", "neutral"], cast: ["solo"], intensity: 2 } },
    { text: "A person who improvises their way into the best moments", tags: { tone: ["comedy", "drama", "neutral"], cast: ["solo", "two"], intensity: 2 } },
    { text: "Someone who doesn't know the rule they're breaking", tags: { tone: ["comedy", "slice-of-life", "neutral"], cast: ["solo"], intensity: 1 } },
    { text: "A person who makes the camera fall in love with them by accident", tags: { tone: ["drama", "tender", "neutral"], cast: ["solo"], intensity: 2 } },
    { text: "Someone who enters a scene like they've been there all along", tags: { tone: ["drama", "neutral", "thriller"], cast: ["solo", "two"], intensity: 2 } },
    { text: "A person who does the physical thing nobody thought to write", tags: { tone: ["comedy", "drama", "neutral"], cast: ["solo"], intensity: 2 } },
    { text: "A person who shows up early and knows everyone's lines", tags: { tone: ["drama", "neutral", "comedy"], cast: ["solo"], intensity: 2 } },
    { text: "Someone who fills any gap without being asked", tags: { tone: ["drama", "tender", "neutral"], cast: ["solo", "two"], intensity: 1 } },
    { text: "A person who remembers the small details that make a scene feel real", tags: { tone: ["drama", "tender", "neutral"], cast: ["solo"], intensity: 1 } },
    { text: "Someone who's happy being small in the frame if the moment is right", tags: { tone: ["drama", "tender", "neutral"], cast: ["solo", "two"], intensity: 1 } },
    { text: "A person who makes the whole crew feel like they're part of something", tags: { tone: ["drama", "tender", "neutral"], cast: ["solo", "two"], intensity: 1 } },
    { text: "Someone who brings something unexpected to the role that changes the whole direction", tags: { tone: ["drama", "experimental", "dark"], cast: ["solo", "two"], intensity: 3 } },
    { text: "A person who asks 'why does my character care about this?' and changes the scene", tags: { tone: ["drama", "tender", "neutral"], cast: ["solo", "two"], intensity: 2 } },
    { text: "Someone who has a look that tells the story before they speak", tags: { tone: ["drama", "mystery", "neutral"], cast: ["solo"], intensity: 2 } },
    { text: "A person who adds texture nobody knew the project needed", tags: { tone: ["drama", "tender", "experimental"], cast: ["solo", "two"], intensity: 2 } },
    { text: "A person who nails it on the first take and makes it look boring", tags: { tone: ["comedy", "drama", "neutral"], cast: ["solo"], intensity: 1 } },
    { text: "Someone who's professional enough to be boring but interesting enough to be cast", tags: { tone: ["comedy", "slice-of-life", "neutral"], cast: ["solo"], intensity: 1 } },
    { text: "A person who brings the same energy to coverage as they do to the lead", tags: { tone: ["drama", "tender", "neutral"], cast: ["solo"], intensity: 1 } },
    { text: "Someone who used to be here—references to them come up in conversation like they just left", tags: { tone: ["drama", "tender", "dark"], cast: ["solo", "two"], intensity: 2 } },
    { text: "A person's routine that someone else has quietly adopted without being asked", tags: { tone: ["tender", "drama", "neutral"], cast: ["solo", "two"], intensity: 1 } }
];
