...
const resources = [
    ...
    {
        id: 'le-juice-rochester',
        added: '2026-07-27',
        name: 'Le Juicé',
        category: 'collaborators',
        desc: 'Cold-pressed juice bar in downtown Rochester, in a space designed by MOZ Interiors.',
        fullDesc: 'Le Juicé is a juice and wellness bar in downtown Rochester, Michigan. The interior is MOZ Interiors work — deep green millwork, terrazzo, brass fixtures and marble counters, assembled with the kind of restraint that makes a small room feel considered rather than decorated. LaB Media filmed a brand piece on location in June 2026.',
        url: 'https://www.lejuicerochester.com',
        instagramUrl: 'https://www.instagram.com/lejuicerochester/',
        features: ['Juice Bar', 'Rochester, MI', 'Brand Film Client', 'MOZ Interior'],
        paid: false
    },
...

    {
        ...
        category: 'community',
        communityType: 'groups',
        desc: 'The most consistently active film community in Detroit — screenings, workshops, and a resources page they actually keep current.',
        fullDesc: 'Campfire Film Cooperative is a Detroit-based film community running workshops, screening series, and filmmaker meetups at The Scarab Club, The Congregation, and other venues around the city. They program more consistently than anyone else in Metro Detroit, they collaborate widely — Weekly Watchlist, The Black Canon, Motor City Cinematheque — and their own resources page is genuinely maintained, which is rarer than it should be. If you only follow one organization in this list, make it this one.',
        url: 'https://campfirefilm.org',
        extraLinks: [
            { label: 'Their resources', url: 'https://campfirefilm.org/resources' },
            { label: 'Events', url: 'https://campfirefilm.org/events' }
        ],
        features: ['Screenings', 'Workshops', 'Detroit', 'Actively updated'],
        labPick: true,
        paid: false
    },
...

    {
        ...
        additionalLinks: [
            ...
            { label: 'The rules', url: 'https://thecomedyroll.com/rules/' }
        ]
    },
...

    {
        ...
        category: 'drone',
        droneType: 'channel',
        desc: 'My own FPV channel — flight footage and whatever I am currently failing to land.',
        fullDesc: 'My personal FPV channel, separate from the LaB Media work. Flight footage, freestyle runs, and progress over time. Included here because the SkyBound path is the one I actually walked, and this is the receipts.',
...

    {
        ...
        url: 'https://claude.ai',
        paid: true,
        inLab: 'Paid plan. This entire site was rebuilt with it — the design system, the story generator, the lot.',
        pricing: [
...

    {
        ...
        paid: true,
        labPick: true,
        inLab: 'Bought the lifetime deal rather than renting a library forever. Most of what you hear under these films came from here.',
        pricing: [
...

    {
        ...
        category: 'soundfx',
        aiType: 'voice',
        desc: 'Voice-driven real-time foley and creature sound design.',
        fullDesc: 'Krotos Studio listens to your voice or controller input and turns it into custom sound effects in real time. Built for expressive foley passes, creature vocals, and fast prototyping straight inside a DAW — the kind of thing that used to mean a library search and a compromise.',
        ...
        features: ['Voice-to-SFX', 'AI-Powered', 'Real-time Processing', 'Foley & Creature']
    },
...

    {
        ...
        fullDesc: 'DaVinci Resolve is professional-grade editing, colour, VFX and audio post in one application. The free version is not a demo — it is genuinely enough to finish a film, and most of what is on this site was cut in it.',
        url: 'https://www.blackmagicdesign.com/products/davinciresolve',
        paid: false,
        labPick: true,
        inLab: 'Running Studio. Worth knowing: the licence often comes bundled free with Blackmagic hardware — a Speed Editor or a small ATEM — so the deal can cost about the same as the software alone and you get a physical thing out of it. That is how LaB ended up with it. The free version still does almost everything; Studio adds the noise reduction and a few effects worth having.'
    },
