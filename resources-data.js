...
const resources = [
    ...
    },
    {
        name: 'DUST',
        category: 'references',
        desc: 'Sci-fi short films exploring the future through speculative storytelling.',
        fullDesc: 'DUST specializes in high-quality science fiction short films that explore technology, humanity, and the future. From dystopian thrillers to thought-provoking dramas, DUST showcases world-class sci-fi storytelling—useful reference for genre filmmaking, atmosphere building, and speculative narratives.',
        url: 'https://www.youtube.com/@watchdust',
        instagramUrl: 'https://www.instagram.com/watchdust/',
        paid: false,
        featuredVideo: 'WaUqgI7VXkk',
        features: ['Sci-Fi Focus', 'Speculative Fiction', 'High Production Value', 'World Building']
    },
    {
        name: 'Film Shortage',
        category: 'references',
    ...
    },
    {
        name: 'Gunpowder + Sky',
        category: 'references',
        desc: 'Genre-driven short films and episodic content across horror, sci-fi, and thriller.',
        fullDesc: 'Gunpowder + Sky (parent company of ALTER) produces genre-focused short films and episodic series with strong production values. Their work spans horror, sci-fi, thriller, and dark comedy—useful for studying genre conventions, atmospheric storytelling, and serialized narratives.',
        url: 'https://www.youtube.com/@gunpowdersky',
        paid: false,
        featuredVideo: 'PaZXPx1kdtg',
        features: ['Genre Content', 'Episodic Series', 'Production Quality', 'Multi-Platform']
    },
    {
        name: 'CBC Gem (Short Docs)',
        category: 'references',
        desc: 'Canadian Broadcasting short documentaries with strong storytelling.',
        fullDesc: 'CBC Gem features compelling short documentaries covering culture, identity, art, and social issues. These shorts balance journalistic rigor with cinematic craft—excellent reference for documentary pacing, interview techniques, and visual storytelling in non-fiction formats.',
        url: 'https://www.youtube.com/@cbcshortdocs',
        paid: false,
        featuredVideo: 'NJW_av0PQXM',
        features: ['Documentary Shorts', 'Cultural Stories', 'Journalistic Craft', 'Canadian Focus']
    },
