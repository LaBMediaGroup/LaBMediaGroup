...
const resources = [
    ...
    },
    {
        ...
        category: 'collaborators',
        shortDesc: 'Animation and motion graphics studio creating explainer videos, brand content, and 2D animation',
        fullDesc: 'Creative animation studio specializing in 2D animation, explainer videos, and motion graphics. Sideways Studio has produced work for brands including Relatable (What Do You Meme, Emotional Support Pals), Hello Giggles, Detroit Chinatown, and numerous tech companies. Their portfolio spans playful character animation, product explainers, board game how-to videos, and corporate motion graphics. Known for fast turnarounds and distinctive visual style that brings brands and products to life through engaging animated content.',
        url: 'https://sidewaysstudio.net',
        paid: false,
        badges: ['collaborator', 'animation', 'motion'],
        pricing: [
            { plan: 'Explainer Videos', price: 'Project-based quote' },
            { plan: 'Motion Graphics', price: 'Project-based' },
            { plan: '2D Animation', price: 'Contact for pricing' }
        ],
        features: [
            '2D animation and motion graphics',
            'Explainer and how-to videos',
            'Brand and product animation',
            'Character animation',
