...
(function(){
  ...
  function loadAssistant(){
    ...
    loading=loadScript('resources-data.js?v=20260731_v4',hasResources)
      ...
      .then(function(){return loadScript('spotlight-data.js?v=20260801_v5',function(){return Boolean(window.SPOTLIGHT);});})
      .then(function(){return loadScript('field-notes-data.js?v=20260801_v5',function(){return Array.isArray(window.LAB_FIELD_NOTES);});})
      .then(function(){return loadScript('assistant-data.js?v=20260801_v5',function(){return Boolean(window.LAB_ASSISTANT_KNOWLEDGE);});})
