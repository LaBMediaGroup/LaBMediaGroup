...
- Open DevTools console on Resources page; confirm no errors.
2026-01-09 | 4:33PM EST
———————————————————————
Change: Default subcategory filters to the leftmost option instead of All across Resources.
Files touched: resources.html, CHANGELOG_RUNNING.md
Notes: Updated default subcategory states and active buttons for Community, Stock, Tools, References, and Drones.
Quick test checklist:
- Load Resources page; select Community/Stock/Tools/References/Drones and confirm the first subcategory button is active by default.
- Toggle Tools → Drone; confirm Part 107 is selected automatically when the drone subfilters appear.
- Open DevTools console on Resources page; confirm no errors.
