...
- Open DevTools console on ideas.html; confirm no errors.
2026-01-12 | 12:09PM EST
———————————————————————
Change: Prevent per-field rerolls from duplicating other prompt values.
Files touched: ideas.html, CHANGELOG_RUNNING.md
Notes: Constraint/twist rerolls now exclude values already used by other prompt cards.
Quick test checklist:
- Open ideas.html; roll prompts, reroll constraint/twist on prompt 1, and confirm it does not match prompt 2 or 3.
- Reroll prompt 2 and verify constraints/twists remain unique across all three prompts.
- Open DevTools console on ideas.html; confirm no errors.
2026-01-12 | 12:11PM EST
———————————————————————
Change: Seed uniqueness pools with locked prompt values before rerolls.
Files touched: ideas.html, CHANGELOG_RUNNING.md
Notes: Locked fields from later prompts are now reserved before rerolling earlier cards.
Quick test checklist:
- Open ideas.html; lock a constraint/twist on prompt 3, click Roll Again, and confirm prompt 1 does not duplicate the locked value.
- Lock a concept on prompt 2, roll again, and confirm prompts remain unique across all cards.
- Open DevTools console on ideas.html; confirm no errors.
