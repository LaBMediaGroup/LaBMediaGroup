...
2026-01-16 | 9:43PM EST
———————————————————————
Change: Improved Anthony Brass text readability with a glassy info panel and reordered hero pills on the home page.
Files touched: portfolio.html, index.html, CHANGELOG_RUNNING.md
Notes: Added a translucent backdrop card behind Anthony Brass text and adjusted mobile padding; reordered hero badges to match the requested sequence.
Quick test checklist:
1. Open portfolio.html and confirm the Anthony Brass text sits on a readable glass panel without overwhelming the background on desktop.
2. Open portfolio.html on mobile width and confirm the info panel padding feels balanced and text remains legible.
3. Open index.html and confirm the hero pills read “Local Focus”, “Events + Resources”, then “Story Generator”.
4. Open DevTools console on portfolio.html and index.html and verify no errors.
