...
const eventsData = [
...

    {
        ...
        startTime: '18:30',
        location: 'The Scarab Club, 217 Farnsworth St, Detroit, MI 48202-4018, United States',
    ...
    {
        id: 'campfire-in-motion-2026-02-19',
        title: 'In Motion (Part 2 of 3): Animation on Film',
        organizer: 'Campfire Film Cooperative',
        type: 'workshop',
        ...
        thumbnail: 'images/CampFireFilm0219.JPG',
        description: 'Part 2 of In Motion, our three-part animation series, features Nat Anderson, cel animator and Studio Manager at Boxfort Detroit.\nNat will discuss cel animation, share her journey into animations, and highlight the importance of creative community through Mograph Mondays.\nA must-attend event for anyone interested in hand-drawn animation, film, and building meaningful creative connections.',
        bio: {
            summary: "Nat Anderson is a cel animator and Studio Manager at Boxfort Detroit. This session explores the craft of hand-drawn animation and the power of creative community.",
            gif: 'images/Campfire.gif',
            highlights: [
                { label: 'Featured Guest', value: 'Nat Anderson (Boxfort)' },
                { label: 'Topic', value: 'Cel Animation & Community' },
                { label: 'Series', value: 'In Motion (Part 2 of 3)' }
            ],
            url: 'https://campfirefilm.org'
        },
        verification: 'verified',
...
const eventsPosterData = [
    ...
    },
    {
        ...
        venue: 'The Scarab Club',
        location: 'The Scarab Club, 217 Farnsworth St, Detroit, MI 48202-4018, United States',
        posterImage: 'images/CampFireFilm0219.JPG',
        description: 'Part 2 of In Motion, our three-part animation series, features Nat Anderson, cel animator and Studio Manager at Boxfort Detroit.\nNat will discuss cel animation, share her journey into animations, and highlight the importance of creative community through Mograph Mondays.\nA must-attend event for anyone interested in hand-drawn animation, film, and building meaningful creative connections.',
        bio: {
            summary: "Nat Anderson is a cel animator and Studio Manager at Boxfort Detroit. This session explores the craft of hand-drawn animation and the power of creative community.",
            highlights: [
